...
<div id="sidebar" class="active">
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu"><ul class="menu">
            ...
            {{--<li class="sidebar-item"><a href="{{ route('careers.apply') }}" target="_blank" class="sidebar-link"><i class="bi bi-box-arrow-up-right"></i><span>Public Application Link</span></a></li>--}}
