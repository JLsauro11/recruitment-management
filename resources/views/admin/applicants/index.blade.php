...
@section('page-subtitle', 'Review and update applicant status')
    ...
    $(document).ready(function () {
        ...
        function getStatusBadge(status) {
            const classes = {
                ...
                'For Examination': 'status-examination',
        ...
        const applicantsTable = $('#applicantsTable').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.applicants.data') }}",
                type: "GET",
                dataType: "json",
        ...
        $('#statusForm').submit(function (e) {
            ...
            const url = "{{ route('admin.applicants.status', ':id') }}"
