...
@section('page-subtitle', 'Manage positions')
...
<div class="card premium-page-card">
    <div class="premium-page-header">
        <div class="premium-page-heading">
            ...
            <div>
                <h4 class="premium-page-title">Position Management</h4>
                <p class="premium-page-subtitle">Manage job positions and connect each role to the correct department.</p>
            </div>
        </div>
        ...
        <div class="modal-content">
            <form id="dataForm">
                ...
                <div class="premium-modal-header">
                    ...
                    <div>
                        <h5 id="modalTitle">Add Position</h5>
                        <p>Create or update position information.</p>
                    </div>
...
$(document).ready(function () {
    ...
    function loadData() {
        ...
        table = $('#dataTable').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.positions.data') }}",
                type: "GET",
                dataType: "json",
                ...
                error: function (xhr) {
                    ...
                    Swal.fire({
                        ...
                        text: xhr.responseJSON?.message
                            || 'Something went wrong while loading positions.'
                    });
                }
            },
...
$('#refreshBtn').on('click', function () {
    ...
    $('#dataTable').on('click', '.editBtn', function () {
        ...
        const url = "{{ route('admin.positions.show', ':id') }}"
            .replace(':id', id);
        ...
        $.ajax({
            ...
            error: function (xhr) {
                Swal.fire({
                    ...
                    title: 'Error',
                    text: xhr.responseJSON?.message
                        || 'Unable to retrieve position information.'
                });
            }
        });
    });
    ...
    $('#dataForm').submit(function (e) {
        ...
        const url = id
            ? "{{ route('admin.positions.update', ':id') }}".replace(':id', id)
        ...
        Swal.fire({
            title: 'Saving...',
            text: 'Please wait while saving the position.',
    ...
    $('#dataTable').on('click', '.deleteBtn', function () {
        ...
        Swal.fire({
            ...
            const url = "{{ route('admin.positions.destroy', ':id') }}"
                .replace(':id', id);
