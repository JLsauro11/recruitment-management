...
@section('page-subtitle', 'Manage departments')
...
<div class="card premium-page-card">
    <div class="premium-page-header">
        <div class="premium-page-heading">
            ...
            <div>
                <h4 class="premium-page-title">Department Management</h4>
                <p class="premium-page-subtitle">Organize company departments and monitor their assigned positions.</p>
            </div>
        </div>
            ...
            <form id="dataForm">
                ...
                <div class="premium-modal-header">
                    ...
                    <div>
                        ...
                        <p>Create or update department information.</p>
                    </div>
...
$('#refreshBtn').on('click', function () {
    ...
    $('#dataTable').on('click', '.editBtn', function () {
        ...
        const url = "{{ route('admin.departments.show', ':id') }}"
            .replace(':id', id);
    ...
    $('#dataForm').submit(function (e) {
        ...
        const url = id
            ? "{{ route('admin.departments.update', ':id') }}".replace(':id', id)
        ...
        Swal.fire({
            title: 'Saving...',
            text: 'Please wait while saving the department.',
    ...
    $('#dataTable').on('click', '.deleteBtn', function () {
        ...
        Swal.fire({
            ...
            const url = "{{ route('admin.departments.destroy', ':id') }}"
                .replace(':id', id);
