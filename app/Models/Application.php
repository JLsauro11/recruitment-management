...
class Application extends Model
{
    ...
    protected $fillable = [
        'applicant_id', 'job_vacancy_id', 'reference_no',
        'status', 'remarks', 'applied_at'
    ];
    ...
    public function statusHistories(){ return $this->hasMany(ApplicationStatusHistory::class); }
    public function formSubmissions(){ return $this->hasMany(FormSubmission::class); }
}
